...
public class ShoppingCartTest {
    ...
    public void setUp() throws Exception {
        ...
        Item item1=new Item.Builder().withId("item-1").withItemType(ItemType.BOOK).withName("Effective Java").withPrice(BigDecimal.valueOf(4000)).build();
       Item item2= new Item.Builder().withId("item-2").withItemType(ItemType.PEN).withName("Pen").withPrice(BigDecimal.valueOf(40)).build();
